...
, displayDashboard : function() {
    ...
    var str = "<div class='statsColumn'>"
            ...
            + "<div class='statsBarContainer'>"
            + "  <div class='statsBar' style='width:"+player.weapon.nbBullets*5+"%;background-color:#993;'>Bullets&nbsp;"+player.weapon.nbBullets+"</div>"
            +"</div>"
            + "<div class='statsBarContainer'>"
            + "  <div class='statsBar' style='width:"+player.weapon.fireCoolDown*2+"%;background-color:orange'>Fire&nbsp;rate:&nbsp;"+player.weapon.fireCoolDown+"</div>"
            + "</div>"
    if(mobsService.bossAlive) str += "<div class='statsBar' style='width:"+mobsService.boss.life+"%;background-color:orange;'>Boss&nbsp;Life:&nbsp;"+mobsService.boss.life+"</div>"+ "</div>"
    str += "</div>"
